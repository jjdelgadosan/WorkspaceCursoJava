...
public class MainEmpleado {
	...
	public static void main(String[] args) {
		...
		// vamos a necesitar dos array, el de todos los empleados para generar el sueldo de cada empleado, 
		// y otro para calcular el sueldo del director, que depende del equipo a su cargo
...
// con el metodo calcularSueldo estamos empleando el polimorfismo, porque llamandolo de la misma manera para 
// cada empleado se calcula su sueldo segun lo que tenga el metodo de cada clase.
